# Указатель по `docs/` — один вход в 54 документа
...
| `investigation_silent_authored_content.md` | **перепись 187 объектов, которых журнал событий не видит** | 16 мертвы в обоих мирах; `recruit_soldiers` и `senator_bribe` — ворота выше потолка клампа; `scripted` задействует половину действий |
